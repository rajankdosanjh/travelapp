...
def reset_db():
    ...
    locations = [
        ...
        {'name': 'St. Paul\'s Cathedral', 'latitude': 51.5138, 'longitude': -0.0983, 'category': 2,
         'tiktok_rating': 4.7},
        {'name': 'Hampton Court Palace', 'latitude': 51.4036, 'longitude': -0.3377, 'category': 2,
         'tiktok_rating': 4.6},
        ...
        {'name': 'Kew Gardens', 'latitude': 51.4787, 'longitude': -0.2956, 'category': 4, 'tiktok_rating': 4.7},
        {'name': 'Regent\'s Park', 'latitude': 51.5310, 'longitude': -0.1593, 'category': 4, 'tiktok_rating': 4.6},
        {'name': 'Greenwich Park', 'latitude': 51.4769, 'longitude': -0.0005, 'category': 4, 'tiktok_rating': 4.5},
